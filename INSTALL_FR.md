...
4. Lancez l'EXE. L'installateur détecte et vérifie le ZIP ou le dossier local `payload` sans retélécharger l'archive.
...
- `usa-europe-retail-r2` — seconde révision retail USA/Europe connue ;
