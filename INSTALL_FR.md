...
1. Téléchargez `EOTInstaller-v1.0.0-beta.3.exe` depuis la [release officielle du projet](https://github.com/GenryTheFox0/Project-2099/releases/tag/v1.0.0-beta.3).
